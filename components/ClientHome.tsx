...
import { LanguageProvider, useLanguage, ProjectData, InsightData } from "@/context/LanguageContext";
...
interface ClientHomeProps {
    initialInsightsEn: InsightData[];
    initialInsightsZh: InsightData[];
}

function HomeContent({ initialInsightsEn, initialInsightsZh }: ClientHomeProps) {
    const { t, getProjectData, language } = useLanguage();
    const [selectedProject, setSelectedProject] = useState<ProjectData | null>(null);
    const [isModalOpen, setIsModalOpen] = useState(false);

    // Select insights based on current language
    const insights = language === 'zh' ? initialInsightsZh : initialInsightsEn;
    ...
    return (
        <main className="min-h-screen flex flex-col relative">
            ...
            {/* Insights Section - Passing data from props */}
